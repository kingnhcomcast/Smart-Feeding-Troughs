...
public class SmartBreedingTroughScreen extends AbstractContainerScreen<SmartBreedingTroughMenu> {
    private static final Identifier CONTAINER_TEXTURE = Identifier.fromNamespaceAndPath(
            Constants.MOD_ID,
            "textures/gui/container/smart_trough.png"
    );

    public SmartBreedingTroughScreen(SmartBreedingTroughMenu abstractContainerMenu, Inventory inventory, Component component) {
